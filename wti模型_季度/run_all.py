...
# 按照指定顺序的文件列表
files = [
    'wti模型_季度/1.1WTI_映射残差_EIA去库幅度non_trend_api.ipynb',
    'wti模型_季度/1.2WTI_映射残差_EIA去库幅度non_trend.ipynb',
    'wti模型_季度/1.3WTI_映射残差_EIA去库幅度_api.ipynb',
    'wti模型_季度/1.4WTI_映射残差_EIA去库幅度.ipynb',
#    'wti模型_季度/2.1WTI_季度_api.ipynb',
#    'wti模型_季度/2.2WTI_季度.ipynb',
